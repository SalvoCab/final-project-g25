...
@Configuration
class KafkaCustomerProducerConfig {
    @Value("\${spring.kafka.consumer.bootstrap-servers}")
    lateinit var kafkaServer: String
    @Bean
    fun customerProducerFactory(): ProducerFactory<String, CustomerKafkaDTO> {
    ...
    @Bean
    fun CustomerKafkaTemplate(): KafkaTemplate<String, CustomerKafkaDTO> {
